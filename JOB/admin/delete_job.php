...
if ($stmt->execute()) {
    ...
    $_SESSION['job_delete_redirect'] = 'job_list.php'; // Redirect to browse.php after modal
} else {
    // Set a session variable for error message
    $_SESSION['job_delete_message'] = 'Error deleting job. Please try again.';
    $_SESSION['job_delete_redirect'] = 'job_list.php'; // Redirect to browse.php after modal in case of failure
}
