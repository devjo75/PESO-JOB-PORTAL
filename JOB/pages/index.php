...
$cover_photo = $row ? "/JOB/uploads/" . htmlspecialchars($row['cover_photo']) : "/JOB/uploads/default_cover.jpg"; // Default if no cover photo is set
...
document.getElementById('coverPhoto').addEventListener('change', function (event) {
    ...
    if (file) {
        ...
        reader.onload = function (e) {
            document.querySelector('#viewPhotoModal img').src = e.target.result;
        };
